...
data class MyData(
    ...
    object serializer : KSerializer<MyData> {
        ...
        override fun save(output: KOutput, obj: MyData) {
            ...
            output.writeSerializableElementValue(serialClassDesc, 3, ModernEnumSerializer<Choice>(), obj.choice)
        ...
        override fun load(input: KInput): MyData {
            ...
            mainLoop@ while (true) {
                ...
                when (idx) {
                    ...
                    3 -> {
                        local3 = input.readSerializableElementValue(serialClassDesc, 3, ModernEnumSerializer<Choice>())
            ...
            if (bitMask and 8 == 0) {
                throw MissingFieldException("choice")
            }
            return MyData(local0, local1!!, local2!!, local3!!, 42)
        }
    }
}
