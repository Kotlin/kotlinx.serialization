...
class BasicSerializationTest {
    ...
    fun testExampleClasses01() {
        captureOutput("ExampleClasses01") { example.exampleClasses01.main() }.verifyOutputLinesStart(
    ...
    fun testExampleClasses04() {
        captureOutput("ExampleClasses04") { example.exampleClasses04.main() }.verifyOutputLines(
    ...
    fun testExampleClasses07() {
        captureOutput("ExampleClasses07") { example.exampleClasses07.main() }.verifyOutputLines(
    ...
    fun testExampleClasses08() {
        captureOutput("ExampleClasses08") { example.exampleClasses08.main() }.verifyOutputLines(
    ...
    fun testExampleClasses10() {
        captureOutput("ExampleClasses10") { example.exampleClasses10.main() }.verifyOutputLinesStart(
    ...
    fun testExampleClasses13() {
        captureOutput("ExampleClasses13") { example.exampleClasses13.main() }.verifyOutputLinesStart(
