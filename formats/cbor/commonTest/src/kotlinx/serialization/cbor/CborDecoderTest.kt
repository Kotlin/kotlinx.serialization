...
class CborDecoderTest {
    ...
    fun testMismatchedByteStringRepresentationError() {
        ...
        assertFailsWithMessage<CborDecodingException>("Expected start of array, but found 40, " +
            "which corresponds to start of a byte string. " +
        ...
        assertFailsWithMessage<CborDecodingException>("Expected start of a byte string, but found 9F, " +
            "which corresponds to start of an array. " +
            "Make sure you correctly set 'alwaysUseByteString' setting " +
            "and/or 'kotlinx.serialization.cbor.ByteString' annotation.") {
