...
//            mapStringBytes = Gen.map(Gen.string(), Gen.byteArray()).generate(),
...
//        assertEquals(message.mapSint32Sint32, restored.mapSint32Sint32Map)
//        assertEquals(message.mapSint64Sint64, restored.mapSint64Sint64Map)
//        assertEquals(message.mapFixed32Fixed32, restored.mapFixed32Fixed32Map)
//        assertEquals(message.mapFixed64Fixed64, restored.mapFixed64Fixed64Map)
//        assertEquals(message.mapSfixed32Sfixed32, restored.mapSfixed32Sfixed32Map)
//        assertEquals(message.mapSfixed64Sfixed64, restored.mapSfixed64Sfixed64Map)
...
//        assertEquals(message.mapStringBytes, restored.mapStringBytesMap)
        assertEquals(
