...
To keep the unknown fields, add a property in type `ProtoUnknownFieldHolder` with default value `null` or `ProtoUnknownFieldHolder.Empty`, and annotation `@ProtoUnknownFields` to your data class.
