...
public class Fields11 {
    ...
    public Fields11(int mask, int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
        this.i1 = i1;
        this.i2 = i2;
        this.i3 = i3;
        this.i4 = i4;
    ...
    public static Fields11 deserialize(Decoder decoder) {
        ...
        while (true) {
            ...
            switch (idx) {
                ...
                case -1:
                    ...
                    return new Fields11(mask, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11);
                default:
