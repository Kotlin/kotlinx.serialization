...
public class Fields3New2 {
    int i1;
    int i2;
    int i3;

    public Fields3New2(int mask, int i1, int i2, int i3) {
        this.i1 = i1;
        this.i2 = i2;
        this.i3 = i3;
    }

    public static Fields3New2 deserialize(Decoder decoder) {
    ...
    private static Fields3New2 byOne(SerialDescriptor var2, CompositeDecoder composite) {
        ...
        return new Fields3New2(Integer.MAX_VALUE, i1, i2, i3);
    }

    private static Fields3New2 readAll(SerialDescriptor var2, CompositeDecoder composite) {
        ...
        while (true) {
            ...
            switch (idx) {
                ...
                case -1:
                    composite.endStructure(var2);
                    return new Fields3New2(mask, i1, i2, i3);
                default:
