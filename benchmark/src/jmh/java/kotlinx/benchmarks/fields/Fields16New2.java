...
public class Fields16New2 {
    ...
    public Fields16New2(int mask, int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        this.i1 = i1;
        this.i2 = i2;
        this.i3 = i3;
        this.i4 = i4;
    ...
    public static Fields16New2 deserialize(Decoder decoder) {
    ...
    private static Fields16New2 byOne(SerialDescriptor var2, CompositeDecoder composite) {
        ...
        return new Fields16New2(Integer.MAX_VALUE, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15, i16);
    }

    private static Fields16New2 readAll(SerialDescriptor var2, CompositeDecoder composite) {
        ...
        while (true) {
            ...
            switch (idx) {
                ...
                case -1:
                    composite.endStructure(var2);
                    return new Fields16New2(mask, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15, i16);
                default:
