...
public class Fields9New2 {
    ...
    public Fields9New2(int mask, int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        this.i1 = i1;
        this.i2 = i2;
        this.i3 = i3;
        this.i4 = i4;
    ...
    public static Fields9New2 deserialize(Decoder decoder) {
    ...
    private static Fields9New2 byOne(SerialDescriptor var2, CompositeDecoder composite) {
        ...
        return new Fields9New2(Integer.MAX_VALUE, i1, i2, i3, i4, i5, i6, i7, i8, i9);
    }

    private static Fields9New2 readAll(SerialDescriptor var2, CompositeDecoder composite) {
        ...
        while (true) {
            ...
            switch (idx) {
                ...
                case -1:
                    composite.endStructure(var2);
                    return new Fields9New2(mask, i1, i2, i3, i4, i5, i6, i7, i8, i9);
                default:
