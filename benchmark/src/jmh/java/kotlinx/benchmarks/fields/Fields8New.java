...
public class Fields8New {
    ...
    public Fields8New(int mask, int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        this.i1 = i1;
        this.i2 = i2;
        this.i3 = i3;
        this.i4 = i4;
    ...
    public static Fields8New deserialize(Decoder decoder) {
        ...
        if (composite.readAll()) {
            ...
            return new Fields8New(Integer.MAX_VALUE, i1, i2, i3, i4, i5, i6, i7, i8);
        } else {
            int mask = 0;
            while (true) {
                ...
                switch (idx) {
                    ...
                    case -1:
                        composite.endStructure(var2);
                        return new Fields8New(mask, i1, i2, i3, i4, i5, i6, i7, i8);
                    default:
