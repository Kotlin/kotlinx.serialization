...
public class Fields30New2 {
    ...
    public Fields30New2(int mask, int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18, int i19, int i20, int i21, int i22, int i23, int i24, int i25, int i26, int i27, int i28, int i29, int i30) {
        this.i1 = i1;
        this.i2 = i2;
        this.i3 = i3;
        this.i4 = i4;
    ...
    public static Fields30New2 deserialize(Decoder decoder) {
    ...
    private static Fields30New2 byOne(SerialDescriptor var2, CompositeDecoder composite) {
        ...
        return new Fields30New2(Integer.MAX_VALUE, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23, i24, i25, i26, i27, i28, i29, i30);
    }

    private static Fields30New2 readAll(SerialDescriptor var2, CompositeDecoder composite) {
        ...
        while (true) {
            ...
            switch (idx) {
                ...
                case -1:
                    composite.endStructure(var2);
                    return new Fields30New2(mask, i1, i2, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15, i16, i17, i18, i19, i20, i21, i22, i23, i24, i25, i26, i27, i28, i29, i30);
                default:
