...
val polymorphicTestModule = object : SerialModule {
    override fun registerIn(context: MutableSerialContext) {
        ...
        context.registerPolymorphicSerializer(OuterBase::class, OuterImpl::class, OuterImpl.serializer())
        context.registerPolymorphicSerializer(OuterBase::class, OuterNullableImpl::class, OuterNullableImpl.serializer())
