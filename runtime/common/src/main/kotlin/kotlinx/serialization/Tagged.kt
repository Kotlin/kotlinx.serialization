...
abstract class IntTaggedOutput : TaggedOutput<Int?>() {
    override final fun KSerialClassDesc.getTag(index: Int): Int? = getSerialId(this, index)
}

abstract class StringTaggedOutput : TaggedOutput<String?>() {
    override final fun KSerialClassDesc.getTag(index: Int): String? = getSerialTag(this, index)
}
