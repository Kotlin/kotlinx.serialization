...
public class SealedClassSerializer<T : Any>(
    ...
    override fun findPolymorphicSerializerOrNull(decoder: CompositeDecoder, klassName: String): KSerializer<out T>? {
        return serialName2Serializer[klassName] ?: super.findPolymorphicSerializerOrNull(decoder, klassName)
    }

    override fun findPolymorphicSerializerOrNull(encoder: Encoder, value: T): KSerializer<out T>? {
        return class2Serializer[value::class] ?: super.findPolymorphicSerializerOrNull(encoder, value)
    }
}
