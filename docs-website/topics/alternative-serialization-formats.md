...
This can improve performance when deserializing data stored in sequential formats. On the JVM, serializers generated by the `kotlinx.serialization` plugin use this optimization.
