...
> function to ensure that the custom serialization logic is applied. For more information, see [Pass a serializer manually](serialization-create-and-use-serializers.md#pass-a-serializer-manually).
>
{style="note"}
