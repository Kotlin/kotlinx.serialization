...
* Dive deeper into handling JSON data and configuring JSON serialization in the [JSON serialization overview](serialization-configure-json-serialization.md).
